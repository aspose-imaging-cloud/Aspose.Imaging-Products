...
description: Sample code for JPEG2000 to   Python Cloud API resize. Use API example code for batch JPEG2000 files  resize within any Python based application. 
---
