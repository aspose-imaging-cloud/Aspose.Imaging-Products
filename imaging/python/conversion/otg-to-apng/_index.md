...
description: Sample code for OTG to APNG  Python Cloud API conversion. Use API example code for batch OTG files to APNG {action} within any Python based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c65cb4cbccba327fab3812b459b9070f" "otg-to-apng.py" >}}
