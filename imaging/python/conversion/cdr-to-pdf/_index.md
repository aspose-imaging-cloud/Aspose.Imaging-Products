...
description: Sample code for CDR to PDF  Python Cloud API conversion. Use API example code for batch CDR files to PDF {action} within any Python based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c4032ad0fb65c5b4f248c18e9de5398b" "cdr-to-pdf.py" >}}
