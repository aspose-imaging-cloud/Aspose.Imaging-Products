...
description: Sample code for CMX to TIFF  Python Cloud API conversion. Use API example code for batch CMX files to TIFF {action} within any Python based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "6971afb688256f67884ecd6a36fac98a" "cmx-to-tiff.py" >}}
