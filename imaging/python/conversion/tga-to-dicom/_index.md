...
description: Sample code for TGA to DICOM  Python Cloud API conversion. Use API example code for batch TGA files to DICOM {action} within any Python based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "487a73796881e3e41a984d74c3fe2dcf" "tga-to-dicom.py" >}}
