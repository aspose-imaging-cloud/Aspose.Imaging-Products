...
description: Sample code for CDR to PNG  Ruby Cloud API conversion. Use API example code for batch CDR files to PNG {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "9750979ba6accc39710e0e7b53c12dc4" "cdr-to-png.rb" >}}
