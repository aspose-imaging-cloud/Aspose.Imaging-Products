...
title:  
weight: 1
url: /Ruby/conversion/cdr-to-jpeg/
description: Sample code for CDR to JPEG  Ruby Cloud API conversion. Use API example code for batch CDR files to JPEG conversion within any Ruby based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert CDR to JPEG via Ruby Cloud API" h2="Transform CDR into JPEG using native Ruby Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="CDR" additionalConversionTag="JPEG" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Convert CDR to JPEG Using Ruby Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert CDR to JPEG via Ruby Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "e54785ae15dcf30c2e6ca5a2cac5dc1a" "cdr-to-jpeg.rb" >}}
