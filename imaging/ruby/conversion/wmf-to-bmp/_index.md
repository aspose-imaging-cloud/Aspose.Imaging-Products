...
description: Sample code for WMF to BMP  Ruby Cloud API conversion. Use API example code for batch WMF files to BMP {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "040747e07fab1371141b0882294758db" "wmf-to-bmp.rb" >}}
