...
description: Sample code for TGA to APNG  Ruby Cloud API conversion. Use API example code for batch TGA files to APNG {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "f4b89ceb26f939a2bebd517d1f84f7d9" "tga-to-apng.rb" >}}
