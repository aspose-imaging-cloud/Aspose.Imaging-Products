...
description: Sample code for DICOM to TIFF  Ruby Cloud API conversion. Use API example code for batch DICOM files to TIFF {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "b5c5be53aafc1d04f3795f177d2567d1" "dicom-to-tiff.rb" >}}
