...
description: Sample code for CMX to GIF  Ruby Cloud API conversion. Use API example code for batch CMX files to GIF {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "2559e2b42479e781661c641e764bfe2c" "cmx-to-gif.rb" >}}
