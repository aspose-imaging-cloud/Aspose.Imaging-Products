...
description: Sample code for OTG to PDF  Ruby Cloud API conversion. Use API example code for batch OTG files to PDF {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "df77a10bbc1e5b3187cf7251b2723dc3" "otg-to-pdf.rb" >}}
