...
description: Sample code for TGA to PSD  Ruby Cloud API conversion. Use API example code for batch TGA files to PSD {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "f4b89ceb26f939a2bebd517d1f84f7d9" "tga-to-psd.rb" >}}
