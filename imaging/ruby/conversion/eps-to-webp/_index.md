...
description: Sample code for EPS to WEBP  Ruby Cloud API conversion. Use API example code for batch EPS files to WEBP {action} within any Ruby based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "b0b1dd1211433a2942f4aacf9f7e30cf" "eps-to-webp.rb" >}}
