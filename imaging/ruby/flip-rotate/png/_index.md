...
title:  
weight: 1
url: /Ruby/flip-rotate/png/
description: Sample code for PNG  Ruby Cloud API rotate & flip. Use API example code for batch PNG files Rotate & Flip  within any Ruby based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Rotate & Flip PNG via Ruby Cloud API" h2="Rotate & Flip PNG using native Ruby Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="PNG" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Rotate & Flip PNG Using Ruby Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Rotate & Flip PNG via Ruby Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "f208ba8545e16e641dcbd74a7582b565" "flip-rotate-png.rb" >}}
