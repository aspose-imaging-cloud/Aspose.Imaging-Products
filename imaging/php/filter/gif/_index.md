...
{{< blocks/products/pf/agp/content h2="How to apply filtering effect to GIF Using PHP Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to applying filtering effect to GIF via PHP Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "3efd752b13775892f6223578d722b52f" "filter-gif.php" >}}
