...
weight: 1
url: /PHP/resize/odg/
description: Sample code for ODG to   PHP Cloud API resize. Use API example code for batch ODG files  resize within any PHP based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Resize ODG via PHP Cloud API" h2="Resize ODG using native PHP Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="ODG" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Resize ODG Using PHP Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Resize ODG via PHP Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "5f4325f72e6ee75fe141a6c2ac1d94c9" "resize-odg.php" >}}
