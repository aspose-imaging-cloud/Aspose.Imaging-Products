...
description: Sample code for DJVU to DICOM  PHP Cloud API conversion. Use API example code for batch DJVU files to DICOM {action} within any PHP based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "ac001848fd4e25675a5e9f594350cc89" "djvu-to-dicom.php" >}}
