...
description: Sample code for CMX to APNG  PHP Cloud API conversion. Use API example code for batch CMX files to APNG {action} within any PHP based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "ebb345f18b59cb49a84ac2680b1650c3" "cmx-to-apng.php" >}}
