...
description: Sample code for TGA to DICOM  PHP Cloud API conversion. Use API example code for batch TGA files to DICOM {action} within any PHP based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "d5a81fda6570a7f5d52a58c383cee783" "tga-to-dicom.php" >}}
