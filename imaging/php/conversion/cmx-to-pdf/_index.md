...
title:  
weight: 1
url: /PHP/conversion/cmx-to-pdf/
description: Sample code for CMX to PDF  PHP Cloud API conversion. Use API example code for batch CMX files to PDF conversion within any PHP based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert CMX to PDF via PHP Cloud API" h2="Transform CMX into PDF using native PHP Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="CMX" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Convert CMX to PDF Using PHP Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert CMX to PDF via PHP Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "596e02b796c4ebf953d5e6a92243df7f" "cmx-to-pdf.php" >}}
