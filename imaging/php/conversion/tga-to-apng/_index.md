...
description: Sample code for TGA to APNG  PHP Cloud API conversion. Use API example code for batch TGA files to APNG {action} within any PHP based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "d5a81fda6570a7f5d52a58c383cee783" "tga-to-apng.php" >}}
