...
description: Sample code for DICOM to PSD  PHP Cloud API conversion. Use API example code for batch DICOM files to PSD {action} within any PHP based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "4536a7ddc18b7feee499b543537d486f" "dicom-to-psd.php" >}}
