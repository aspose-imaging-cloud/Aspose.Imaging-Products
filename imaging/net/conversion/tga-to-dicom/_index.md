...
description: Sample code for TGA to DICOM  C# Cloud API conversion. Use API example code for batch TGA files to DICOM {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c62920c2df66631770042a639a43dc72" "tga-to-dicom.cs" >}}
