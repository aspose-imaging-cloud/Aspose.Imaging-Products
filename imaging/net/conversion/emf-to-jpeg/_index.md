...
description: Sample code for EMF to JPEG  C# Cloud API conversion. Use API example code for batch EMF files to JPEG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c4c38152fe6fd77bac3d7bef19eed3a1" "emf-to-jpeg.cs" >}}
