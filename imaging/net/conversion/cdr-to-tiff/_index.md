...
description: Sample code for CDR to TIFF  C# Cloud API conversion. Use API example code for batch CDR files to TIFF {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "a8b32cbe6ca5c3f9f58c44f3dda8404e" "cdr-to-tiff.cs" >}}
