...
description: Sample code for TIFF to PDF  C# Cloud API conversion. Use API example code for batch TIFF files to PDF conversion within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-examples" "b954877ec4f56f9a801aac085b6e2c0d" "tiff-to-pdf.cs" >}}
