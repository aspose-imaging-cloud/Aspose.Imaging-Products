...
description: Sample code for TGA to PDF  C# Cloud API conversion. Use API example code for batch TGA files to PDF {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c62920c2df66631770042a639a43dc72" "tga-to-pdf.cs" >}}
