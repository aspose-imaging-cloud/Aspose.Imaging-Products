...
description: Sample code for OTG to APNG  C# Cloud API conversion. Use API example code for batch OTG files to APNG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "5c3a131b8ed9adf9d6e0492a7defda89" "otg-to-apng.cs" >}}
