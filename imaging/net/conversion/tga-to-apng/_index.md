...
description: Sample code for TGA to APNG  C# Cloud API conversion. Use API example code for batch TGA files to APNG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "c62920c2df66631770042a639a43dc72" "tga-to-apng.cs" >}}
