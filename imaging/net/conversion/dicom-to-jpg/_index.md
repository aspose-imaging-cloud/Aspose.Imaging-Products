...
description: Sample code for DICOM to JPG  C# Cloud API conversion. Use API example code for batch DICOM files to JPG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "851618d971d7f8479e934112143d5bb7" "dicom-to-jpg.cs" >}}
