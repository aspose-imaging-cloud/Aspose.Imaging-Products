...
description: Sample code for WMF to PDF  C# Cloud API conversion. Use API example code for batch WMF files to PDF {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "4a20c9e6b93c3c57b688e24ee66e71f9" "wmf-to-pdf.cs" >}}
