...
description: Sample code for WMF to SVGZ  C# Cloud API conversion. Use API example code for batch WMF files to SVGZ conversion within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-examples" "5018130018ef65e6b9e7c8930b61c0a7" "wmf-to-svgz.cs" >}}
