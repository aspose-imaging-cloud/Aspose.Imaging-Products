...
description: Sample code for CMX to APNG  C# Cloud API conversion. Use API example code for batch CMX files to APNG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "9087b440a4c2375a976120d365199a4d" "cmx-to-apng.cs" >}}
