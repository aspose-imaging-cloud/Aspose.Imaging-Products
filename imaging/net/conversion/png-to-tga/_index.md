...
description: Sample code for PNG to TGA  C# Cloud API conversion. Use API example code for batch PNG files to TGA {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "dea442b3157b6cb8a2ce7e5a8017cf81" "png-to-tga.cs" >}}
