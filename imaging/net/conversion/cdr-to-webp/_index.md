...
description: Sample code for CDR to WEBP  C# Cloud API conversion. Use API example code for batch CDR files to WEBP conversion within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-examples" "698ed61263a8efef63a22cecc6c33c84" "cdr-to-webp.cs" >}}
