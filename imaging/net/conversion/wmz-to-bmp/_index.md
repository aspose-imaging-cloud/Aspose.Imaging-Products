...
description: Sample code for WMZ to BMP  C# Cloud API conversion. Use API example code for batch WMZ files to BMP {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "dbca7382e3092548657733ee4484e474" "wmz-to-bmp.cs" >}}
