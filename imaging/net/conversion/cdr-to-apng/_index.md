...
description: Sample code for CDR to APNG  C# Cloud API conversion. Use API example code for batch CDR files to APNG {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "a8b32cbe6ca5c3f9f58c44f3dda8404e" "cdr-to-apng.cs" >}}
