...
description: Sample code for CMX to PSD  C# Cloud API conversion. Use API example code for batch CMX files to PSD {action} within any .NET based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "9087b440a4c2375a976120d365199a4d" "cmx-to-psd.cs" >}}
