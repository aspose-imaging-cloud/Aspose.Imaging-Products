...
{{< blocks/products/pf/agp/content h2="How to Resize EMF Using Java Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Resize EMF via Java Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "c7cc58a1708703f0e371cd64eba63e44" "resize-emf.java" >}}
