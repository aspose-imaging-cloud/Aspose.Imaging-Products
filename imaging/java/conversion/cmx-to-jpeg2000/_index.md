...
description: Sample code for CMX to JPEG2000  Java Cloud API conversion. Use API example code for batch CMX files to JPEG2000 {action} within any Java based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "eee6ea0f8324fac287be19ca802fd9fd" "cmx-to-jpeg2000.java" >}}
