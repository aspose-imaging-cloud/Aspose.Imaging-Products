...
description: Sample code for DICOM to BMP  Java Cloud API conversion. Use API example code for batch DICOM files to BMP {action} within any Java based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "3966ab54310fa14d0cbf837b3cbb90f1" "dicom-to-bmp.java" >}}
