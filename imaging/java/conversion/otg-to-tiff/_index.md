...
description: Sample code for OTG to TIFF  Java Cloud API conversion. Use API example code for batch OTG files to TIFF {action} within any Java based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "22d595c89eb8ecb9169a7eacc2a723cb" "otg-to-tiff.java" >}}
