...
description: Sample code for CDR to WEBP  Java Cloud API conversion. Use API example code for batch CDR files to WEBP {action} within any Java based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "bc72c13d2bfed2d848d1f4aa0fee8fd0" "cdr-to-webp.java" >}}
