...
description: Sample code for TGA to DICOM  Java Cloud API conversion. Use API example code for batch TGA files to DICOM {action} within any Java based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "6534e76af503c5ebae7d3f364ee57999" "tga-to-dicom.java" >}}
