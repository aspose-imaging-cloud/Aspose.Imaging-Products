...
{{< blocks/products/pf/agp/content h2="How to apply filtering effect to GIF Using Java Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to applying filtering effect to GIF via Java Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "5905d65eae397504d44ba14d2ae22c37" "filter-gif.java" >}}
