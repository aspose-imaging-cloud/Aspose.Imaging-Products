...
title:  
weight: 1
url: /NodeJs/crop/apng/
description: Sample code for APNG  NodeJs Cloud API crop. Use API example code for batch APNG files  crop within any NodeJs based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Crop APNG via NodeJs Cloud API" h2="Crop APNG using native NodeJs Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="APNG" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Crop APNG Using NodeJs Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Crop APNG via NodeJs Cloud API" %}}
...
{{< gist "aspose-imaging-cloud-examples" "fce0d1b2985e7b51098bbb5ae01e2647" "crop-apng.ts" >}}
