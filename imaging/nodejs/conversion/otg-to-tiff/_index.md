...
description: Sample code for OTG to TIFF  NodeJs Cloud API conversion. Use API example code for batch OTG files to TIFF {action} within any NodeJs based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "a51add5645ba4202adcd27f9db70f917" "otg-to-tiff.ts" >}}
