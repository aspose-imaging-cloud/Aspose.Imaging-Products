...
description: Sample code for EMF to TIFF  NodeJs Cloud API conversion. Use API example code for batch EMF files to TIFF {action} within any NodeJs based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "5f544ac894abdfd1a45d9e3ee72807b1" "emf-to-tiff.ts" >}}
