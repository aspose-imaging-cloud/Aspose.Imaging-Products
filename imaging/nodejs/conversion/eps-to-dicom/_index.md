...
title:  
weight: 1
url: /NodeJs/conversion/eps-to-dicom/
description: Sample code for EPS to DICOM  NodeJs Cloud API conversion. Use API example code for batch EPS files to DICOM conversion within any NodeJs based application. 
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert EPS to DICOM via NodeJs Cloud API" h2="Transform EPS into DICOM using native NodeJs Cloud APIs without needing any image editor or 3rd-party libraries." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/imaging/aspose_imaging-for-net.svg" sourceAdditionalConversionTag="EPS" additionalConversionTag="DICOM" pfName="Aspose.Imaging.Cloud" subTitlepfName="for " downloadUrl="" fileiconsmall1="HTML" fileiconsmall2="JPG" fileiconsmall3="PDF" fileiconsmall4="XML" fileiconsmall5="APNG" >}}
...
{{< blocks/products/pf/agp/content h2="How to Convert EPS to DICOM Using NodeJs Cloud API" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert EPS to DICOM via NodeJs Cloud API" %}}
...
{{< blocks/products/pf/agp/code-block title="Convert EPS to DICOM - Cloud" offSpacer="" >}}

{{< gist "aspose-imaging-cloud-examples" "8c47a13f6fb345d8ee959de064e6e2ba" "eps-to-dicom.ts" >}}
...
Flexible integrations options including SDKs for various languages ([Python](https://products.aspose.cloud/imaging/python/conversion/eps-to-dicom), [Ruby](https://products.aspose.cloud/imaging/ruby/conversion/eps-to-dicom), [.NET](https://products.aspose.cloud/imaging/net/conversion/eps-to-dicom), [Java](https://products.aspose.cloud/imaging/java/conversion/eps-to-dicom), [NodeJS](https://products.aspose.cloud/imaging/nodejs/conversion/eps-to-dicom), [PHP](https://products.aspose.cloud/imaging/php/conversion/eps-to-dicom)) and the use of the REST API allow to make the integration easy.
