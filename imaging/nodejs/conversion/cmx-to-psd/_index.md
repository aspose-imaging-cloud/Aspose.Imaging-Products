...
description: Sample code for CMX to PSD  NodeJs Cloud API conversion. Use API example code for batch CMX files to PSD {action} within any NodeJs based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "4ca30d35a7afcaa9fbe43765b1a0e6f7" "cmx-to-psd.ts" >}}
