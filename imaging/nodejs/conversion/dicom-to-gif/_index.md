...
description: Sample code for DICOM to GIF  NodeJs Cloud API conversion. Use API example code for batch DICOM files to GIF {action} within any NodeJs based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "90418f917e87dea3d85ca2edd0091214" "dicom-to-gif.ts" >}}
