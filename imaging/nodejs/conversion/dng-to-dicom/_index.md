...
description: Sample code for DNG to DICOM  NodeJs Cloud API conversion. Use API example code for batch DNG files to DICOM {action} within any NodeJs based application. 
---
...
{{< gist "aspose-imaging-cloud-gists" "a93553946a25700a42171a0c6ebcc11f" "dng-to-dicom.ts" >}}
